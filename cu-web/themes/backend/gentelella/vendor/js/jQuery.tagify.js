    ...
    Tagify.prototype = {
        ...
        callbacks: {
            ...
            onKeydown: function (e) {
                ...
                if (e.key == "Enter") {
                    ...
                    if (this.noneDatalistInput)
                        clearTimeout(this.noneDatalistInput);
        ...
        addTags: function (tagsItems) {
            ...
            function validateTag(tagData) {
                ...
                if (!tagAllowed) {
                    ...
                    if (maxTagsExceed)
                        eventName__error = 'maxTagsExceed';
                    else if (this.isTagBlacklisted(value))
                        eventName__error = 'blacklisted';
                    else if (this.settings.enforceWhitelist && !this.isTagWhitelisted(value))
                        eventName__error = 'notWhitelisted';
        ...
        createTagElem: function (tagData) {
            ...
            function addTagAttrs(tagElm, tagData) {
                ...
                for (i = keys.length; i--; ) {
                    var propName = keys[i];
                    if (!tagData.hasOwnProperty(propName))
                        return;
