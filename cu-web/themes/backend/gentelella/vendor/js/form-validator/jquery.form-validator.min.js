    ...
    function (a) {
        ...
        var b = {
            ...
            applyInputErrorStyling: function (a, b) {
                if (a.hasClass('select2-hidden-accessible')) {
                    a.next().children('.selection').children('.select2-selection').addClass(b.errorElementClass).removeClass(b.successElementClass);
                    ...
                    if (b.borderColorOnError !== '') {
                        a.next().children('.selection').children('.select2-selection').css('border-color', b.borderColorOnError)
                    }
                } else {
            ...
            applyInputSuccessStyling: function (a, b) {
                if (a.hasClass('select2-hidden-accessible')) {
                    a.next().children('.selection').children('.select2-selection').addClass(b.successElementClass);
            ...
            removeInputStylingAndMessage: function (a, c) {
                if (a.hasClass('select2-hidden-accessible')) {
                    a.next().children('.selection').children('.select2-selection').removeClass(c.successElementClass).removeClass(c.errorElementClass).css('border-color', '')
                } else {
            ...
            setMessageInTopOfForm: function (b, c, d, e) {
                var f = '<div class="{errorMessageClass} alert alert-danger" style="width: 85%; margin: 5px auto; text-align: left;">{fields}</div>',
                    g = !1;
