function init_modalScreen() {
    var Hsc = $(window).height();
    var Wsc = $(window).width();

    if ($('.modal-screen').length > 0) {
        $('.modal-screen').on('shown.bs.modal', function () {
            // setTimeout(function(){console.log(Wsc +" x "+Hsc)}, 200);
            if ($('.modal-screen.in .modal-body > .tab-content').length > 0) {
                $('.modal-screen').find('.modal-body').height(Hsc - (70+56+20+35));

                $('.modal-screen .modal-body .tab-content .tab-pane > div').height($('.modal-screen .modal-body').height() - 65);
                $(".modal-screen .modal-body .tab-content .tab-pane > div").mCustomScrollbar({
                    theme : 'dark-thick',
                    scrollInertia : 500
                });
                ...
                $('.modal-screen').find('.modal-body').height(Hsc - (70+60+40));

                $('.modal-screen .modal-body > div.content').height($('.modal-screen .modal-body').height() - 10);
                $('.modal-screen .modal-body > div.content').mCustomScrollbar({
                    theme : 'dark-thick',
                    scrollInertia : 500
                });
    ...
    if ($('.modal-screen-custom').length > 0) {
        $('.modal-screen-custom').on('shown.bs.modal', function () {
            // setTimeout(function(){console.log(Wsc +" x "+Hsc)}, 200);
            $('.modal-screen-custom').find('.modal-body').height(Hsc - (70+56+20+35));
            $('.modal-screen-custom .modal-body .tab-content .tab-pane > div').height($('.modal-screen-custom .modal-body').height() - 65);
            $(".modal-screen-custom .modal-body .tab-content .tab-pane > div").mCustomScrollbar({
                theme : 'dark-thick',
                scrollInertia : 500
            });
        });
...
function init_sidebar() {
    ...
    $.fn.mCustomScrollbar&&$(".menu_fixed").mCustomScrollbar( {
        autoHideScrollbar:!0, theme:"minimal", scrollInertia : 150, mouseWheel: {
            preventDefault: !0,
        }
    }
    )
