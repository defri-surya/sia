...
<script>
    ...
    function chooseMember(com, grid, urlaction) {
        ...
        if ($('.trSelected', grid).length > 0) {
            ...
            $('#payment-info').hide();
            ajaxRequest('common/general/transaction/payment/get_option_payment', 'GET', {
    ...
    $(document).ready(function() {
        ...
        $('#modal-choose-member').on('focusout', 'tr.control-row', function(e) {
            if (($("#modal-choose-member").data('bs.modal') || {
                    isShown: false
                }).isShown) {
                if (($("#gridview-member_formModalFilter").data('bs.modal') || {
                        isShown: false
                    }).isShown) {
                    $('#modal-choose-member').find('.trSelected').removeClass('trSelected');
                } else if (($("#modal-option-payment").data('bs.modal') || {
                        isShown: false
                    }).isShown) {
                    $('#modal-choose-member').find('.trSelected').removeClass('trSelected');
                } else if (($("#modal-history-payment").data('bs.modal') || {
                        isShown: false
                    }).isShown) {
                    $('#modal-choose-member').find('.trSelected').removeClass('trSelected');
                }
            ...
            $.ajax({
                ...
                success: function(res) {
                    if (res.status == 200) {
                        ...
                        $('#gridview').flexReload();
                        $('#modal-option-payment .modal-body').animate({
                            scrollTop: '0px'
                        }, 300);
                        $('#payment-type').focus();
        ...
        if (typeof gridMemberBalanceLogMonthly == 'undefined') {
            gridMemberBalanceLogMonthly = $("#gridview-member-balance-log-monthly").flexigrid({
                ...
                colModel: [{
                    ...
                    {
                        display: 'Kredit (Rp)',
                        name: 'balance_log_kedit',
                        width: 120,
                        sortable: true,
                        align: 'right'
                    },
                    {
                        display: 'Saldo Terakhir (Rp)',
                        name: 'balance_log_last_balance',
                        width: 120,
                        sortable: true,
                        align: 'right'
                    },
                    {
                        display: 'Waktu Input Sistem',
                        name: 'balance_log_input_datetime',
                        width: 200,
                        sortable: true,
                        align: 'center'
                    },
                    {
                        display: 'Nama Admin',
                        name: 'balance_log_administrator_name',
                        width: 200,
                        sortable: true,
                        align: 'left',
                        hide: true
                    ...
                    {
                        display: 'Username Admin',
                        name: 'balance_log_administrator_username',
                        width: 200,
                        sortable: true,
                        align: 'left',
                        hide: true
        ...
        if (typeof gridMemberSavingLog == 'undefined') {
            gridMemberSavingLog = $("#gridview-member-saving-log").flexigrid({
                ...
                params: [{
                    ...
                    name: "saving_id",
                    value: paymentMemberProductSavingId
                }],
                dataType: 'json',
                colModel: [{
                        display: 'Tanggal Pembayaran',
                        name: 'member_product_saving_log_datetime',
                        width: 200,
                        sortable: true,
                        align: 'center'
                    },
                    {
                        display: 'No. Bukti',
                        name: 'member_product_saving_log_code',
                        width: 120,
                        sortable: true,
                        align: 'center'
                    },
                    {
                        display: 'Debet (Rp)',
                        name: 'member_product_saving_log_debet',
                        width: 120,
                        sortable: true,
                        align: 'right'
                    },
                    {
                        display: 'Kredit (Rp)',
                        name: 'member_product_saving_log_kredit',
                        width: 120,
                        sortable: true,
                        align: 'right'
                    },
                    {
                        display: 'Saldo Terakhir (Rp)',
                        name: 'member_product_saving_log_last_balance',
                        width: 120,
                        sortable: true,
                        align: 'right'
                    },
                    {
                        display: 'Waktu Input Sistem',
                        name: 'member_product_saving_log_input_datetime',
                        width: 200,
                        sortable: true,
                        align: 'center'
                    },
                    {
                        display: 'Nama Admin',
                        name: 'member_product_saving_log_input_admin_name',
                        width: 200,
                        sortable: true,
                        align: 'left',
                        hide: true
                    ...
                    {
                        display: 'Username Admin',
                        name: 'member_product_saving_log_input_admin_username',
                        width: 200,
                        sortable: true,
                        align: 'left',
                        hide: true
    ...
    $.key('alt+c', function() {
        if (!($("#modal-choose-member").data('bs.modal') || {
            ...
            if (($("#gridview_formModalFilter").data('bs.modal') || {
                    isShown: false
                }).isShown) {
        ...
        if (($("#modal-choose-member").data('bs.modal') || {
            ...
            if (!($("#modal-option-payment").data('bs.modal') || {
                    isShown: false
                }).isShown) {
                if (($("#gridview-member_formModalFilter").data('bs.modal') || {
                        isShown: false
        ...
        if (($("#modal-history-payment").data('bs.modal') || {
                isShown: false
            }).isShown) {
            if (paymentName != 'saving' && paymentName != 'loan') {
                let indexPayment = arrOptionPayment.findIndex(item => item.name == paymentName);
                let period = arrOptionPayment[indexPayment].period;
                if (period == 'monthly') {
                    if (($("#gridview-member-balance-log-monthly_formModalFilter").data('bs.modal') || {
                            isShown: false
                        }).isShown) {
                    ...
                    if (($("#gridview-member-balance-log-annually_formModalFilter").data('bs.modal') || {
                            isShown: false
                        }).isShown) {
            ...
            if (paymentName == 'saving') {
                if (($("#gridview-member-saving-log_formModalFilter").data('bs.modal') || {
                        isShown: false
                    }).isShown) {
