    ...
    <div class="modal-dialog modal-lg" style="width: 90%;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Form Pembayaran Angsuran Pinjaman</h4>
            </div>
        ...
        <div class="modal-content">
            ...
            <form id="form-payment-loan" class="form-horizontal form-label-left" data-url="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <ul id="container-tab-period" class="nav nav-tabs bar_tabs" role="tablist">
                                <li class="active"><a data-toggle="tab" href="#tab-payment">Bayar Angsuran Pinjaman</a></li>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="openModalConfirmation()" class="btn btn-primary"><i class="fa fa-check"></i>&nbsp; Proses Pembayaran</button>
                    <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
                </div>
            </form>
        </div>
...
<div id="modal-confirmation" class="modal" role="dialog" tab-index="-1" style="overflow-y: hidden">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Form Konfirmasi Pembayaran Angsuran Pinjaman</h4>
            </div>
            <div class="modal-body" style="overflow-y: auto; max-height: calc(100vh - 200px)">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        Yakin akan melakukan pembayaran angsuran pinjaman atas nama <span id="confirm-member-name"></span> ?
                        <br>
...
<script>
    ...
    function filterByDate() {
        ...
        if (dates != '') {
            ...
            $("#gridview").flexOptions({
                url: siteUrl + 'transaction/loan/get_data',
                params: [{
                    name: "start_date",
                    value: startDate
                }, {
    ...
    $(document).ready(function() {
        ...
        $('#form-payment-loan').on('submit', function(e) {
            ...
            let urlForm = siteUrl + 'transaction/loan/act_add_paid';
    ...
    $("#gridview").flexigrid({
        ...
        buttons: [
            ...
            if (privilege_view('add', $this->menu_privilege)) :
                echo "
                    {display: 'I<u>n</u>put Pembayaran Angsuran Pinjaman', name: 'payment', bclass: 'accounting', onpress: openModalChooseMember},
                    ";
            endif;
            ?>
        ],
    ...
    function loadFlexigridMember() {
        if (typeof gridMember == 'undefined') {
            gridMember = $('#gridview-member').flexigrid({
                url: siteUrl + 'transaction/loan/get_data_member',
                dataType: 'json',
                colModel: [
                    {display: 'No. Anggota', name: 'member_code', width: 80, sortable: true, align: 'center'},
