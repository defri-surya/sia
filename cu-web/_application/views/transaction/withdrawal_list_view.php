...
<div id="modal-option-payment" class="modal" role="dialog" style="overflow-y: hidden" tabindex="-1">
    <div class="custom-loading"><span></span></div>
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
...
<div id="modal-option-withdrawal" class="modal" role="dialog" style="overflow-y: hidden" tabindex="-1">
    <div class="custom-loading"><span></span></div>
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
...
//            {display: 'Unit', name: 'branch_name', width: 100, sortable: true, align: 'left', hide:true},
        ...
        buttons: [
            ...
            if (privilege_view('add', $this->menu_privilege)):
                echo "
                    {display: 'Penarikan Simpanan', name: 'payment', bclass: 'accounting', onpress: openWithdrawal},
                    ";
            endif;
            ?>
        ],
